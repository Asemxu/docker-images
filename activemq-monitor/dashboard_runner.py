...
print(os.environ.get("AMQ_HOSTS"))
print(os.environ.get("AMQ_USER"))
print(os.environ.get("AMQ_PASS"))
print(os.environ.get("AMQ_PORT"))

try:
    AMQ_HOSTS = os.environ.get("AMQ_HOSTS")
    AMQ_USER = os.environ.get("AMQ_USER")
    AMQ_PASS = os.environ.get("AMQ_PASS")
    AMQ_PORT = os.environ.get("AMQ_PORT") or 8163
...
def get_broker_metrics_by_queue(queue_name: str, broker_host: str) -> dict:
    ...
    print(f"https://{broker_host}:{AMQ_PORT}/admin/xml/queues.jsp")
...
def metric_analyser():
    while True:
        if total_queues_metrics:
            ...
            params = {
                'queue_A': total_queues_metrics.get('QUEUE/A', 2),
                'queue_B': total_queues_metrics.get('QUEUE/B',2),
                'queue_C': total_queues_metrics.get('QUEUE/C', 2),
                'queue_D': total_queues_metrics.get('QUEUE/D', 2)
            }
